...
// all the value in the Helper to global
...
function uncache (modulePath) {
  try {
    ...
    console.log(`Module ${modulePath} uncached.`);
  } catch (e) {
    console.error(`Error uncaching module ${modulePath}: ${e}`);
  }
};

function nocache (modulePath, cb = () => {}) {
  console.log(`Module ${modulePath} detected!`);
  import.meta.url;
  import.meta.url;
  import.meta.url;
